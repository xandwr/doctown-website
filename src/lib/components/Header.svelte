...
<header class="sticky top-0 z-50 border-b border-neutral-900 bg-black/95 backdrop-blur-sm">
	<div class="max-w-[1200px] mx-auto px-5 md:px-8 h-16 flex items-center justify-between">
		<!-- Logo / Brand -->
		<a href="/" class="text-lg font-normal text-white hover:text-neutral-300 transition-colors no-underline">
			doctown
		</a>
			...
			{#if user}
				...
				<div class="relative">
					...
					>
						...
						<svg
							class="w-4 h-4 text-neutral-500 transition-transform {dropdownOpen ? 'rotate-180' : ''}"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
